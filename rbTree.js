 ...
 */
/*
 Properties of red black trees: self-balancing binary search tree
 -root node is black
 -children of red nodes are black
 -black depth is the same for every path from an external node to the root
 -all external nodes are black
 */
(function (window) {
        function TreeBase() {
        }
        TreeBase.prototype.size = function() {
            return this._size;
        }
...
// otherwise, returns previous node
        ...
        window.RBTree = function(comparator) {
            this._root = null;
...
// returns true if removed, false if not found
    ...
    RBTree.prototype.prepareD3Tree = function () {
        if (this._root === null)
            return;
